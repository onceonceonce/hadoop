...
# 获取指定URL地址 singurl 中的房屋信息
def getDetail(singurl):
    print('正在获取-------------->>>>>>>', singurl) #获取的网页地址
...
for j in range(1, 20):
    print('当前获取页码------------', j)
    url = 'https://bj.ke.com/ershoufang/yizhuangkaifaqu/pg' + str(j) + '/'
